...
plt.plot(time_axis, np.sin(2 * np.pi * time_axis * 800))
plt.show()

# c)
freq_signal = 240
duration = 1
t = np.linspace(0, duration, 60)
plt.plot(t, freq_signal * t - np.floor(freq_signal * t))
...
plt.plot(t, np.sign(np.sin(2 * np.pi * freq_signal * t)))
...
# a)
print(
    "Pentru cu frecventa de esantionare de 2000 Hz , intervalul intre 2 esantioane este " + f"{1 / 2000: .4f}" + " secunde")

# b)
print(
    "O ora de achizitie, pentru un esantion memorat pe 4 biti, la o frecv de esantionare de 2000 Hz, timp de o ora, va ocupa " + f"{4 * 2000 * 60 * 60 / 8 / 1024}" + " MB")
